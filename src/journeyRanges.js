 ...
 * pages=15, that maps across the whole journey so far (overview -> membrane ->
 * inside -> Gate 1 -> matrix -> electron transport chain).
 */
...
const MATRIX_START = 0.52
const MATRIX_END = 0.72
